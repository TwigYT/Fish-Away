...
import net.mcreator.fishaway.init.FishAwayModTabs;
...
@Mod("fish_away")
public class FishAwayMod {
	public static final Logger LOGGER = LogManager.getLogger(FishAwayMod.class);
	public static final String MODID = "fish_away";

	public FishAwayMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		FishAwayModBlocks.REGISTRY.register(modEventBus);

		FishAwayModItems.register(modEventBus);

		FishAwayModTabs.REGISTRY.register(modEventBus);
